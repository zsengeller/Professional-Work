function frame1(){
  ...
  TweenLite.set(".txt1", {scale:.95});
  TweenLite.set(".txt2", {scale:.95});
  TweenLite.set(".txt3", {scale:.95});
  ...
  tl
  //.staggerTo(".startFrame", 1, { y:-150, ease:Sine.easeOut}, 0.05)
  //.to("#text", 0, {opacity: 1, ease:Back.easeOut})
  tl
  ...
  .staggerFrom(".txt3", 0.5, {opacity:0, y:"+=10", ease:Back.easeOut, scale:.7}, 0.05, "+=.1");
