...
function frame2(){
  ...
  TweenLite.set(".endFrame", {x:728, y:-107});

  tl
  .staggerTo(".endFrame", 0.5, { x:728, ease:Back.easeOut}, 0.05, "+=.5")
  .staggerTo(".endFrame", 0.5, { x:600, ease:Back.easeOut}, "+=2")
  .staggerFrom(".txt4", 0.5, {opacity:0, ease:Elastic.easeOut.config(.5, 0.2), scale:.5, onComplete:pulse}, "+=.25")
  .to(".endFrame", 0.5, { x:350, ease:Back.easeOut}, "+=.5")


  .to(".txt4", 0.5, {x:-250, ease:Back.easeOut}, "-=.5")
