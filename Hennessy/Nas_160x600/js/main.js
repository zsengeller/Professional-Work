function slide1(){
  ...
  tl//reveal the first slide and content
    .from("#bg1", 2, {scale: .8, x: "+=60", ease: Linear.easeNone})
...
function slide5(){//bottle
  ...
  TweenMax.set("#bottle", {opacity:0, y:100, x:0});
  tl
  .to("#bottle", 2, {scale: .85, y:0, x:0, opacity:1, ease: Cubic.easeIn}, "-=.65")
  .from(".txt6", 1, {opacity: 0, ease: Cubic.easeIn}, "-=.6");
  tl
  .to(assets, 1.25, {opacity: 0, ease: Cubic.easeIn});
  return tl;
}
