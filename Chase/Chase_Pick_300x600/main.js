...
function fgAnim() {
    ...
    // fade line 2
    .from(".text2", 0.75, {autoAlpha:0, ease:Sine.easeOut, force3d:true, rotationZ:0.01}, "+=0.1")
    .to(".text2", 0.75, {autoAlpha:0, ease:Expo.easeInOut}, "+=2" )
    // fade line 3
    .from(".text3", 0.75, {autoAlpha:0, ease:Sine.easeOut, force3d:true, rotationZ:0.01}, "+=0.1")
...
function init() {
    ...
    masterTl.set(".wrapper", {autoAlpha:1}) // make the whole banner visible
    .add(bgAnim(), 0.5)
    .add(fgAnim(), 0.5);
