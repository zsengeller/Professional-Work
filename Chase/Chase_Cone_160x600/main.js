...
function bgAnim(){//background animation
    ...
    tl
    .add("start")
    .set(".bg", {scale:1.2, x:"-10px", y:"-50px"})
    .to(".bg", 9, {scale:1, y:"+=50", x:0, ease:Linear.easeNone, force3d:true, rotationZ:0.01}, "start")
...
function fgAnim(){//foreground animation
    ...
    tl
    .from(".text1", 0.75, {autoAlpha:0, scale:0.8, ease:Sine.easeOut})// fade in text 1
    .to(".text1", 0.75, {autoAlpha:0, ease:Expo.easeInOut}, "+=2" )

    .from(".text2", 0.75, {autoAlpha:0, scale:0.8, ease:Sine.easeOut}, "+=0.1")// fade in text 2
    .to(".text2", 0.75, {autoAlpha:0, ease:Expo.easeInOut}, "+=2" )

    .from(".text3", 0.75, {autoAlpha:0, scale:0.8, ease:Sine.easeOut}, "+=0.1")// fade in text 3
